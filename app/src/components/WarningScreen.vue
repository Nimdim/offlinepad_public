    ...
    <span>
      ...
      >
        ...
        >
          ...
          <p>
            2.2 Программный продукт построен с использованием технологий хранения данных в браузере. Очистка кеша может повлечь потерю данных Пользоватля Программного продукта. Пользователь самостоятельно обеспечивает резервное копирование своих данных. Разработчик не несет ответственности за потерю данных вызванную очисткой кеша браузера или его удалением с устройства Пользователя.
          </p>
        </li>
        <li class="collection-item">
          <button
